...
<b><i>Note: Phonebook Assistant Skill `v.1.1` also fixes some bugs from the 1.0 version.</i></b>
...
- Train the assistant
- Test the assistant by typing `All countries` and `Show country FI`, for example 
(in case these fail make sure to have some COUNTRY entity values e.g. '<i>FI</i>' and '<i>US</i>'. Add if necessary and then try again.)
